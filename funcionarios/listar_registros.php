    ...
    <div>
      <ul class="pagination justify-content-center">
        ...
        <li class="page-item <?= ($pagina_atual <= 1) ? 'disabled' : '' ?>">
          <a class="page-link"
            href="?pagina=<?= $pagina_atual - 1 ?>&funcionario_id=<?= $filtro_funcionario ?>&data_inicio=<?= $filtro_data_inicio ?>&data_fim=<?= $filtro_data_fim ?>">Anterior</a>
        </li>
        ...
        <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
          <li class="page-item <?= ($i == $pagina_atual) ? 'active' : '' ?>">
            <a class="page-link"
              href="?pagina=<?= $i ?>&funcionario_id=<?= $filtro_funcionario ?>&data_inicio=<?= $filtro_data_inicio ?>&data_fim=<?= $filtro_data_fim ?>">
              <?= $i ?>
            </a>
          </li>
        <?php endfor; ?>
        ...
        <li class="page-item <?= ($pagina_atual >= $total_paginas) ? 'disabled' : '' ?>">
          <a class="page-link"
            href="?pagina=<?= $pagina_atual + 1 ?>&funcionario_id=<?= $filtro_funcionario ?>&data_inicio=<?= $filtro_data_inicio ?>&data_fim=<?= $filtro_data_fim ?>">Próximo</a>
        </li>
